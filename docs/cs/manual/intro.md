...
> [!NOTE]
> Este documento NO contiene IA. La documentación del codigo está escrita en su mayoría por IA temporalmente con el objetivo de ayudar rápidamente a quien lo lea sin que muera yo en el proceso de redacción de cada propiedad, pero este documento está redactado a mano. La documentación del codigo eventualmente será reeditada a medida que se vaya manteniendo el código subyacente. Verá la etiqueta correspondiente en la parte superior del archivo cuando un archivo haya sido modificado por una IA.
